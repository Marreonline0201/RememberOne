...
- CRITICAL — unnamed family members: If a family member is mentioned but has no name, still add them to "family_members" with a placeholder name. For a single unnamed member use the relation capitalized (e.g. "Son", "Daughter"). For multiple unnamed members of the same relation, number them (e.g. "Son 1", "Son 2"). Never omit a family member just because they are unnamed.
